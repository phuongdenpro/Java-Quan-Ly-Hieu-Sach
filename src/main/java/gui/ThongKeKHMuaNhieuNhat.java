...
//			
	...
	public void renderData() throws SQLException {
		Map<KhachHang, Map<String, Integer>> dskh = new KhachHangDAO().thongKeKHTN(10);
		...
		lblTongSoTien.setText(String.valueOf(tongSoTien)+"đ");
		table.revalidate();
		table.repaint();
	}
	...
	public void renderData(Date tuNgay, Date toiNgay) throws SQLException {
		...
		Map<KhachHang, Map<String, Integer>> dskh = new KhachHangDAO().thongKeKHTN(tuNgay, toiNgay, limit);
